...
@Module({
  ...
  providers: [
    ...
    { provide: APPLE_IDENTITY_VERIFIER, useClass: AppleJwksAdapter },
    { provide: APPLE_AUTH_CLIENT, useClass: AppleAuthApiAdapter },
    { provide: APPLE_CREDENTIALS, useClass: PrismaAppleCredentialsAdapter },
    { provide: PROVIDER_TOKEN_CIPHER, useClass: AesGcmTokenCipherAdapter },
